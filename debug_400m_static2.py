...
# Override to use the increased max_missed_frames
pipeline.assigner.max_missed_frames = 600
...
track_pts = _add_tracking_grid(geom, calib_pts, None)
...
for fi in range(max_frames):
    ...
    if fi % 200 == 0:
        ...
        print(f'fi={fi}: athletes={n_ath}, finished={n_fin}, race_started={pipeline.timer.race_started}, race_finished={pipeline.timer.race_finished}')
